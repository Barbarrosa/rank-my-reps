...
const getUpdateRowScoreFn = (row: ScoredBill, support: boolean): () => Promise<void> => {
    return async () => {
            ...
            columns={[
                {
                    ...
                    render: (row: ScoredBill) => {
                        return <a href={row.bill.congressdotgov_url}>
                                {row.bill.number}
                            </a>;
                    },
                    title: '#',
                ...
                },
                {
                    customSort: (row1: ScoredBill, row2: ScoredBill) => {
                        ...
                        // true > null > false
                        switch(true) {
                            case support1 && support2: return 0;
                            case support1 === false && support2 === false: return 0;
                            case support1 === null && support2 === null: return 0;

                            case support1 === true && support2 === false: return 1;
                            case support1 === null && support2 === false: return 1;
                            case support1 === true && support2 === null: return 1;

                            case support1 === false && support2 === true: return -1;
                            case support1 === null && support2 === true: return -1;
                            case support1 === false && support2 === null: return -1;
                        }
                    ...
                    render: (row: ScoredBill) => {
                        ...
                        return <span>
                            <span title="support"><ThumbUp className={classes.thumb} color={good ? "inherit" : "disabled"} onClick={getUpdateRowScoreFn(row,true)} /></span>
                            <span title="oppose"><ThumbDown className={classes.thumb} color={good === false ? "inherit" : "disabled"} onClick={getUpdateRowScoreFn(row,false)}/></span>
                            </span>;
                    },
                    title: 'Preference',
                }
